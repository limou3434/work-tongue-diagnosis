package cn.com.edtechhub.worktonguediagnosis;

import cn.com.edtechhub.worktonguediagnosis.config.ServerConfig;
import cn.com.edtechhub.worktonguediagnosis.config.SpringdocConfig;
...
@Slf4j
public class WorkTongueDiagnosisApplication {

    public static void main(String[] args) {
        var context = SpringApplication.run(WorkTongueDiagnosisApplication.class, args);
