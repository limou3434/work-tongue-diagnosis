package cn.com.edtechhub.worktonguediagnosis.exception;
 ...
 */
@RestControllerAdvice(basePackages = "cn.com.edtechhub.worktonguediagnosis.controller") // 使用 @RestControllerAdvice 可以拦截所有 @RestController 中抛出的异常, 并统一返回 JSON 格式的错误信息, 不过由于版本过新, 需要考虑问题 https://github.com/xiaoymin/knife4j/issues/884
@Slf4j
